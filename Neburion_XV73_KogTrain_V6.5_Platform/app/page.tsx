    ...
    <main id="top">
      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="heroCopy">
          <p className="eyebrow a11yEyebrow">Neburion XV73 · V6.5</p>
      ...
      <section className="journeyTeaser" aria-labelledby="journey-teaser-title">
        <div><p className="eyebrow a11yEyebrow">Dein Trainingsstart</p><h2 id="journey-teaser-title">Ein Einstieg. Danach geht es direkt los.</h2><p>Wähle 5, 10 oder 15 Minuten und entscheide zwischen persönlichem Lernmix, Spezial-Labs oder Gehirnfit & Alltag.</p></div>
        <div className="journeyTeaserMeta"><span><strong>5 / 10 / 15</strong><small className="a11yMetaLabel">Minuten</small></span><span><strong>3</strong><small className="a11yMetaLabel">Trainingswege</small></span><Link className="primary" href="/training/journey">Training zusammenstellen →</Link></div>
      </section>

      <section className="learningLibrary" id="lernbereiche" aria-labelledby="learning-title">
        <div className="sectionHead"><div><p className="eyebrow a11yEyebrow">Individuell lernen</p><h2 id="learning-title">Was möchtest du verbessern?</h2></div><p>Wähle die Fähigkeiten, die heute wichtig sind. KogTrain stellt daraus eine passende Einheit zusammen.</p></div>
        <div className="learningGrid">{FOCUS_AREAS.map((area)=><article className={`learningCard learning-${area.id}`} key={area.id}><span className="learningIcon" aria-hidden="true">{area.icon}</span><p className="eyebrow a11yEyebrow">{area.subtitle}</p><h3>{area.title}</h3><p>{area.description}</p></article>)}</div>
      ...
      <section className="worlds" id="training" aria-labelledby="worlds-title">
        <div className="sectionHead"><div><p className="eyebrow a11yEyebrow">Spezial-Labs</p><h2 id="worlds-title">Fünf Bereiche für tieferes Training.</h2></div><p>Memory, Attention, Logic, Language und Visual sind für Einheiten gedacht, bei denen du einen Schwerpunkt bewusst vertiefen möchtest.</p></div>
      ...
      <section className="learningLibrary" id="gehirnfit" aria-labelledby="brainfit-title">
        <div className="sectionHead"><div><p className="eyebrow a11yEyebrow">Gehirnfit & Alltag</p><h2 id="brainfit-title">Ruhig trainieren. Alltag stärken.</h2></div><p>Zwölf Übungswelten, ein Tagesmix und viele wechselnde Aufgaben. Ohne unnötigen Zeitdruck und mit klarer Rückmeldung.</p></div>
