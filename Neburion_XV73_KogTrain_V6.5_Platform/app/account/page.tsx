...
export default function AccountPage() {
  return <main className="trainingPage">
    <div className="trainingTopbar"><Link className="backLink" href="/profile">← Zu den Spielerprofilen</Link><span>KogTrain V12 · Cloud Accounts</span></div>
    <section style={{ width: "min(900px, calc(100% - 2rem))", margin: "4rem auto 6rem" }}>
      <p style={{ fontWeight: 900, letterSpacing: ".1em", textTransform: "uppercase", color: "#087f82" }}>V12 · Account & Sync</p>
