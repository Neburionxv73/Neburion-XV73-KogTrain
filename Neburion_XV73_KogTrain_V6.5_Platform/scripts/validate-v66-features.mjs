...
expect("Logic UI uses generative engine", logicTraining.includes("createLogicSession") && logicTraining.includes("LOGIC_STORAGE_KEY") && !logicTraining.includes("20er Aufgabenpool"));
