...
const checks = [
  ...
  ["crossword grid generation", training.includes("buildCrossword") && training.includes("CrosswordPuzzle") && training.includes("crosswordGrid")],
  ...
  ["2x2 sudoku visual regions", hardeningCss.includes("nth-child(4n+2)") && hardeningCss.includes("nth-child(n+5):nth-child(-n+8)")],
