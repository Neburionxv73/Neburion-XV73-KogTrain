...
expect("V12: adaptive journey remains primary CTA", dashboard.includes('/training/journey') && dashboard.includes("primaryButton"));
expect("V12: progress architecture is present", dashboard.includes('id="fortschritt"') && dashboard.includes('id="analyse"') && dashboard.includes('id="wiederholung"') && dashboard.includes('id="rhythmus"') && dashboard.includes("GranularWeaknessV1") && dashboard.includes("TargetedRepeatV1"));
...
expect("V12: no fabricated progress values", dashboard.includes("snapshot?.") && dashboard.includes("hasTrainingData") && dashboard.includes("totalSessions") && !dashboard.includes("Math.random"));
...
expect("V12: clean training area actions exist", dashboard.includes("startButton") && dashboard.includes("moreButton") && dashboard.includes("lab.href") && dashboard.includes('/training/journey'));
expect("V12: editorial support cards exist", dashboard.includes("quoteCard") && dashboard.includes("tipCard") && dashboard.includes("dashboard.consistency") && dashboard.includes("dashboard.didYouKnow"));
